...
export class StudentService {
  ...
  getPlayerIndexByAgentId (agentId: string): number {
    const playerList = this.getPlayingStudents()
    return playerList.indexOf(this.getStudent(agentId))
  }

  setCurrentPlayer (agentId: string): void {
    this.currentPlayerIndex = this.getPlayerIndexByAgentId(agentId)
  }
