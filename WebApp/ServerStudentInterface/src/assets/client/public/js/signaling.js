...
export class WebSocketSignaling extends EventTarget {
  ...
  constructor() {
    ...
    if (location.protocol === "https:") {
      websocketUrl = "wss://" + SERVERURL +"/";
    } else {
      websocketUrl = "ws://" + SERVERURL +"/";
    }
    // websocketUrl = "wss://arete-webrtc.vicomtech.org/"; // Hard-coded for testing against the remote machine
